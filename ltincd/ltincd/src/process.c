...
// Do not write to pidfile when running on iOS - it causes a runtime failure on iOS
//
...
// Do not detach from the terminal if running in iOS, since this process will be started from an App
// and not a terminal
/*
	if(do_detach) {
#ifndef HAVE_MINGW
